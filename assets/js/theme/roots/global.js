...
export default function loaded() {
    ...
    function calcHeaderHeightMobile() {
        ...
        if (pageOffset > mobileHeaderHeight) {
            ...
            // had to comment the below out because it was 
            // giving a padding od like 10% above the header
            //Very strange, will most likely cause problems in the future.
            //-Robbie 5038034458
        ...
        if (pageOffset === 0) {
            ...
            // had to comment the below out because it was 
            // giving a padding of like 20% above the header and 
            // setting the navUser 
            /// magnifying glass up 62 pixkels by setting the style
            // in the li element as "top: -62px", which must be headerNoNavHeight.  
            //Very strange, will most likely cause problems in the future.
            //-Robbie 5038034458
